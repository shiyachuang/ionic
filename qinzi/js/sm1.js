...
+function ($) {
    ...
    function handleClicks(e) {
       var chenyufei = $(".picker-selected");
       var chen = "";
       // console.log(chenyufei[0])
       if ($(chenyufei[0]).text()=="北京") {
            chen="北京"
       }else if ($(chenyufei[0]).text()=="上海") {
            chen="上海"
       }
       else if ($(chenyufei[0]).text()=="重庆") {
            chen="重庆"
       }
       else if ($(chenyufei[0]).text()=="天津") {
            chen="天津"
       }
        else if ($(chenyufei[0]).text()=="香港") {
            chen="香港"
       } else if ($(chenyufei[0]).text()=="澳门") {
            chen="澳门"
       } else if ($(chenyufei[0]).text()=="台湾") {
            chen="台湾"
       } else if ($(chenyufei[0]).text()=="海外") {
            chen="海外"
       }
       else{
           for(var i= 0;i<chenyufei.length;i++){
                chen = $(chenyufei[i]).text();
           }
        }
       $("#city-picker").val(chen);
